...
const DataSneakerContext = createContext(null);
function DataSneakerProvider({ config, children }) {
    ...
    return (jsx(DataSneakerContext.Provider, { value: clientRef.current, children: children }));
}
...
export { DataSneakerClient, DataSneakerContext, DataSneakerProvider, usePageView, useTracker };
